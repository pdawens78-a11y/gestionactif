...
namespace GestionInventaire.DAL.Migrations
{
    ...
    [Migration("20260515062025_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Actif", b =>
                {
                    ...
                    b.Property<string>("CodeInventaire")
                        .IsRequired()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Affectation", b =>
                {
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Categorie", b =>
                {
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.InvitationToken", b =>
                {
                    ...
                    b.HasIndex("IdUtilisateur")
                        .IsUnique()
                        .HasFilter("[IdUtilisateur] IS NOT NULL");
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.MouvementStock", b =>
                {
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Produit", b =>
                {
                    b.Property<int>("IdProduit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Utilisateur", b =>
                {
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Actif", b =>
                {
                    b.HasOne("GestionInventaire.Domain.Entities.Produit", "Produit")
                        .WithMany("Actifs")
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Affectation", b =>
                {
                    b.HasOne("GestionInventaire.Domain.Entities.Actif", "Actif")
                        .WithMany("Affectations")
                        .HasForeignKey("IdActif")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GestionInventaire.Domain.Entities.Employe", "Employe")
                        .WithMany("Affectations")
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.AuditLog", b =>
                {
                    b.HasOne("GestionInventaire.Domain.Entities.Utilisateur", null)
                        .WithMany("AuditLogs")
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.InvitationToken", b =>
                {
                    b.HasOne("GestionInventaire.Domain.Entities.Utilisateur", "Utilisateur")
                        .WithOne("InvitationToken")
                        .HasForeignKey("GestionInventaire.Domain.Entities.InvitationToken", "IdUtilisateur")
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.MouvementStock", b =>
                {
                    b.HasOne("GestionInventaire.Domain.Entities.Stock", "Stock")
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Produit", b =>
                {
                    b.HasOne("GestionInventaire.Domain.Entities.Categorie", "Categorie")
                        .WithMany("Produits")
            ...
            modelBuilder.Entity("GestionInventaire.Domain.Entities.Stock", b =>
                {
                    b.HasOne("GestionInventaire.Domain.Entities.Produit", "Produit")
                        .WithOne("Stock")
                        .HasForeignKey("GestionInventaire.Domain.Entities.Stock", "IdProduit")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
